        ...
        if(ask[no])
        {
            ...
            {         //queestion function calls
             ...
             case 1:
                ...
                case 2:
                   question("3. Wrapping data and its related functionality into a single entity is known as ___" , "Abstraction" , "Encapsulation" , "Polymorphism" , "Modularity" , 'b');
                   break;
             case 3:
             ...
             case 5:
                ...
                case 6:
                   question("7. C++ is __" , "procedural programming language" , "object oriented programming language" , "Cobal language" , "Fortran Language" , 'b');
                   break;
             case 7:
